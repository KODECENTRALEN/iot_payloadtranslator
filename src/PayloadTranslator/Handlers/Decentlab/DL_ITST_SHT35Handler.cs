                ...
                foreach (var rec in decoded)
                {
                    switch (rec.Key)
                    {
                        ...
                        case "Surface temperature":
                            response.Measurements.Add(MeasurementType.temperature_road_c.ToString(), rec.Value.Item1);
                            break;
                        case "Head temperature":
                            response.Measurements.Add(MeasurementType.temperature_head_c.ToString(), rec.Value.Item1);
                            break;
                        default:
                            break;
                    }
