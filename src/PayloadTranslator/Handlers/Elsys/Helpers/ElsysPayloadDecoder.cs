...
namespace Handlers
{
    ...
    public class ElsysPayloadDecoder
    {
        ...
        public MessageResult DecodePayload(string payload)
        {
            try
            {
            ...
            for (var i = 0; i < data.Count; i++)
            {
                switch (data[i])
                {
                    ...
                    case Constants.Temperature1Type: //// External temperature value.
                        ...
                        result.ExternalTemperature1 = extTemp / 10D;
                        i += 2;
                        break;
                    ...
                    case Constants.PressureType: //// External Pressure value.
                        ...
                        result.ExternalPressure = (double)temp / 1000;
                        i += 4;
                        break;
                    ...
                    case Constants.Temperature2Type: //// External temperature 2 value.
                        ...
                        result.ExternalTemperature2 = externalTemperature2 / 10D;
                        i += 2;
                        break;
